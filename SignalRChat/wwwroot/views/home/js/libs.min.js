...
!function(e, t) {
    ...
    _.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (C(Object(e)) ? _.merge(n, "string" == typeof e ? [e] : e) : a.call(n, e)),
            n
        },
    ...
    _.escapeSelector = function(e) {
        return (e + "").replace(M, A)
    }
    ;
    var P = v
      , O = a;
    !function() {
        var t, i, r, a, l, c, d, p, h, m, v = O, g = _.expando, y = 0, b = 0, x = ee(), w = ee(), C = ee(), M = ee(), A = function(e, t) {
            return e === t && (l = !0),
            0
        }, L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", j = "(?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", F = "\\[[\\x20\\t\\r\\n\\f]*(" + j + ")(?:" + D + "*([*^$|!~]?=)" + D + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + j + "))|)" + D + "*\\]", z = ":(" + j + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", N = new RegExp(D + "+","g"), R = new RegExp("^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*"), q = new RegExp("^[\\x20\\t\\r\\n\\f]*([>+~]|[\\x20\\t\\r\\n\\f])[\\x20\\t\\r\\n\\f]*"), H = new RegExp(D + "|>"), $ = new RegExp(z), B = new RegExp("^" + j + "$"), W = {
            ID: new RegExp("^#(" + j + ")"),
            CLASS: new RegExp("^\\.(" + j + ")"),
            TAG: new RegExp("^(" + j + "|[*])"),
            ATTR: new RegExp("^" + F),
        ...
        }, U = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, Y = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, X = /[+~]/, K = new RegExp("\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\([^\\r\\n\\f])","g"), V = function(e, t) {
        ...
        try {
            v.apply(n = o.call(P.childNodes), P.childNodes),
            ...
            v = {
                ...
                call: function(e) {
                    O.apply(e, o.call(arguments, 1))
                }
            }
        }
        function J(e, t, n, i) {
            var o, r, a, s, l, u, d, m = t && t.ownerDocument, y = t ? t.nodeType : 9;
            if (n = n || [],
            ...
            p)) {
                    ...
                    if (o = l[1]) {
                        if (9 === y) {
                            ...
                            if (a.id === o)
                                return v.call(n, a),
                                n
                        } else if (m && (a = m.getElementById(o)) && J.contains(t, a) && a.id === o)
                            return v.call(n, a),
                            n
                    } else {
                        if (l[2])
                ...
                if (!(M[e + " "] || h && h.test(e))) {
                    if (d = e,
                    m = t,
                    1 === y && (H.test(e) || q.test(e))) {
                        for ((m = X.test(e) && se(t.parentNode) || t) == t && f.scope || ((s = t.getAttribute("id")) ? s = _.escapeSelector(s) : t.setAttribute("id", s = g)),
                        r = (u = ue(e)).length; r--; )
        ...
        function le(e) {
            ...
            d.msMatchesSelector && P != c && (t = c.defaultView) && t.top !== t && t.addEventListener("unload", Q),
            f.getById = ne((function(e) {
                return d.appendChild(e).id = _.expando,
            ...
            ne((function(e) {
                ...
                e.querySelectorAll("[selected]").length || h.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|" + L + ")"),
                ...
                e.appendChild(t),
                e.querySelectorAll("[name='']").length || h.push("\\[[\\x20\\t\\r\\n\\f]*name[\\x20\\t\\r\\n\\f]*=[\\x20\\t\\r\\n\\f]*(?:''|\"\")")
            }
            )),
            f.cssHas || h.push(":has"),
            ...
            A = function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === n ? e === c || e.ownerDocument == P && J.contains(P, e) ? -1 : t === c || t.ownerDocument == P && J.contains(P, t) ? 1 : a ? s.call(a, e) - s.call(a, t) : 0 : 4 & n ? -1 : 1)
            }
            ,
            c) : c
        }
        ...
        i = _.expr = {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(K, V),
                    e[3] = (e[3] || e[4] || e[5] || "").replace(K, V),
                    "~=" === e[2] && (e[3] = " " + e[3] + " "),
                    e.slice(0, 4)
                },
                CHILD: function(e) {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return W.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && $.test(n) && (t = ue(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    : function(t, n, l) {
                        var c, u, d, p, f, h = r !== a ? "nextSibling" : "previousSibling", m = t.parentNode, v = s && t.nodeName.toLowerCase(), b = !l && !s, x = !1;
                        if (m) {
                            if (r) {
                                for (; h; ) {
                                    for (d = t; d = d[h]; )
                                        if (s ? T(d, v) : 1 === d.nodeType)
                                            return !1;
                            ...
                            a && b) {
                                for (x = (p = (c = (u = m[g] || (m[g] = {}))[e] || [])[0] === y && c[1]) && c[2],
                                d = p && m.childNodes[p]; d = ++p && d && d[h] || (x = p = 0) || f.pop(); )
                                    if (1 === d.nodeType && ++x && d === t) {
                                        u[e] = [y, p, x];
                                        break
                                    }
                            } else if (b && (x = p = (c = (u = t[g] || (t[g] = {}))[e] || [])[0] === y && c[1]),
                            !1 === x)
                                for (; (d = ++p && d && d[h] || (x = p = 0) || f.pop()) && (!(s ? T(d, v) : 1 === d.nodeType) || !++x || (b && ((u = d[g] || (d[g] = {}))[e] = [y, x]),
                                d !== t)); )
                                    ;
                ...
                PSEUDO: function(e, t) {
                    var n, o = i.pseudos[e] || i.setFilters[e.toLowerCase()] || J.error("unsupported pseudo: " + e);
                    return o[g] ? o(t) : o.length > 1 ? (n = [e, e, "", t],
        ...
        function ue(e, t) {
            ...
            l = [],
            c = i.preFilter; s; ) {
                for (a in n && !(o = R.exec(s)) || (o && (s = s.slice(o[0].length) || s),
                l.push(r = [])),
                n = !1,
                ...
                s = s.slice(n.length)),
                i.filter)
                    !(o = W[a].exec(s)) || c[a] && !(o = c[a](o)) || (n = o.shift(),
                    r.push({
                        value: n,
                        type: a,
                        matches: o
        ...
        function me(e, t, n, i, o, r) {
            ...
            o && !o[g] && (o = me(o, r)),
            te((function(r, a, l, c) {
                var u, d, p, f, h = [], m = [], g = a.length, y = r || function(e, t, n) {
                    for (var i = 0, o = t.length; i < o; i++)
                        J(e, t[i], n);
                    return n
                }(t || "*", l.nodeType ? [l] : l, []), b = !e || !r && t ? y : he(y, h, e, l, c);
                if (n ? n(b, f = o || (r ? e : g || i) ? [] : a, l, c) : f = b,
                i)
                    for (u = he(f, m),
                    i(u, [], l, c),
                    d = u.length; d--; )
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (d = f.length; d--; )
                            (p = f[d]) && (u = o ? s.call(r, p) : h[d]) > -1 && (r[u] = !(a[u] = p))
                    }
                } else
                    f = he(f === a ? f.splice(g, f.length) : f),
                    o ? o(null, a, f, c) : v.apply(a, f)
            }
            ))
        }
        function ve(e) {
                ...
                if (n = i.relative[e[u].type])
                    ...
                    if ((n = i.filter[e[u].type].apply(null, e[u].matches))[g]) {
                        ...
                        return me(u > 1 && fe(f), u > 1 && de(e.slice(0, u - 1).concat({
                            value: " " === e[u - 2].type ? "*" : ""
                        })).replace(I, "$1"), n, u < o && ve(e.slice(u, o)), o < a && ve(e = e.slice(o)), o < a && de(e))
                    }
                    f.push(n)
                }
            return fe(f)
                ...
                s = C(e, function(e, t) {
                    var n = t.length > 0
                      ...
                      , a = function(a, s, l, u, d) {
                        var f, h, m, g = 0, b = "0", x = a && [], w = [], C = r, T = a || o && i.find.TAG("*", d), S = y += null == C ? 1 : Math.random() || .1, E = T.length;
                        for (d && (r = s == c || s || d); b !== E && null != (f = T[b]); b++) {
                            if (o && f) {
                                for (h = 0,
                                s || f.ownerDocument == c || (le(f),
                                l = !p); m = e[h++]; )
                                    if (m(f, s || c, l)) {
                                        v.call(u, f);
                                        break
                        ...
                        n && b !== g) {
                            ...
                            v.apply(u, w),
                            d && !a && w.length > 0 && g + t.length > 1 && _.uniqueSort(u)
                        }
                        return d && (y = S,
                        r = C),
                        x
        ...
        function ye(e, t, n, o) {
            var r, a, s, l, c, u = "function" == typeof e && e, d = !o && ue(e = u.selector || e);
            if (n = n || [],
            1 === d.length) {
                if ((a = d[0] = d[0].slice(0)).length > 2 && "ID" === (s = a[0]).type && 9 === t.nodeType && p && i.relative[a[1].type]) {
                    if (!(t = (i.find.ID(s.matches[0].replace(K, V), t) || [])[0]))
                        return n;
                    u && (t = t.parentNode),
                    e = e.slice(a.shift().value.length)
                }
                for (r = W.needsContext.test(e) ? 0 : a.length; r-- && (s = a[r],
                !i.relative[l = s.type]); )
                    if ((c = i.find[l]) && (o = c(s.matches[0].replace(K, V), X.test(a[0].type) && se(t.parentNode) || t))) {
                        if (a.splice(r, 1),
                        !(e = o.length && de(a)))
                            return v.apply(n, o),
                            n;
            ...
            return (u || ge(e, d))(o, t, !p, n, !t || X.test(e) && se(t.parentNode) || t),
            n
        }
    ...
    _.fn.extend({
        ...
        is: function(e) {
            return !!N(this, "string" == typeof e && F.test(e) ? _(e) : e || [], !1).length
        }
    });
    var R, q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (_.fn.init = function(e, t, n) {
        ...
        "string" == typeof e) {
            ...
            if (i[1]) {
                ...
                _.merge(this, _.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : v, !0)),
                z.test(i[1]) && _.isPlainObject(t))
                    for (i in t)
    ...
    _.each({
        ...
        _.fn[e] = function(n, i) {
            ...
            this.length > 1 && ($[e] || _.uniqueSort(o),
            H.test(e) && o.reverse()),
            this.pushStack(o)
        }
    }
    ...
    _.Callbacks = function(e) {
        e = "string" == typeof e ? function(e) {
            var t = {};
            return _.each(e.match(W) || [], (function(e, n) {
                t[n] = !0
            }
            )),
            t
                ...
                then: function(t, i, o) {
                    ...
                    function a(t, n, i, o) {
                        return function() {
                            var s = this
                              ...
                              , c = function() {
                                ...
                                if (!(t < r)) {
                                    ...
                                    h(c) ? o ? c.call(e, a(r, n, U, o), a(r, n, Z, o)) : (r++,
                                    c.call(e, a(r, n, U, o), a(r, n, Z, o), a(r, n, U, n.notifyWith))) : (i !== U && (s = void 0,
                                    l = [e]),
                                    (o || n.resolveWith)(s, l))
                                }
                            }
                              , u = o ? c : function() {
                                try {
                                    ...
                                    _.Deferred.exceptionHook && _.Deferred.exceptionHook(e, u.error),
                                    t + 1 >= r && (i !== Z && (s = void 0,
                                    l = [e]),
                                    n.rejectWith(s, l))
                                }
                            ...
                            ;
                            t ? u() : (_.Deferred.getErrorHook ? u.error = _.Deferred.getErrorHook() : _.Deferred.getStackHook && (u.error = _.Deferred.getStackHook()),
                            e.setTimeout(u))
                        }
                    }
                    return _.Deferred((function(e) {
                        n[0][3].add(a(0, e, h(o) ? o : U, e.notifyWith)),
    ...
    var K = _.Deferred();
    function V() {
        v.removeEventListener("DOMContentLoaded", V),
    ...
    _.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --_.readyWait > 0 || K.resolveWith(v, [_]))
        }
    }),
    _.ready.then = K.then,
    "complete" === v.readyState || "loading" !== v.readyState && !v.documentElement.doScroll ? e.setTimeout(_.ready) : (v.addEventListener("DOMContentLoaded", V),
    ...
    _.fn.extend({
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (o = re.get(r),
                1 === r.nodeType && !oe.get(r, "hasDataAttrs"))) {
                    for (n = a.length; n--; )
                        a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = te(i.slice(5)),
                        le(r, i, o[i]));
            ...
            return "object" == typeof e ? this.each((function() {
                ...
                var n;
                if (r && void 0 === t)
                    return void 0 !== (n = re.get(r, e)) || void 0 !== (n = le(r, e)) ? n : void 0;
                this.each((function() {
                    re.set(this, e, t)
                }
                ))
    ...
    _.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = oe.get(e, t),
                n && (!i || Array.isArray(n) ? i = oe.access(e, t, _.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    _.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; a--; )
                (n = oe.get(r[a], e + "queueHooks")) && n.empty && (i++,
                n.empty.add(s));
            return s(),
            o.promise(t)
        }
    ...
    function ve(e, t, n, i) {
        ...
        , l = s(), c = n && n[3] || (_.cssNumber[t] ? "" : "px"), u = e.nodeType && (_.cssNumber[t] || "px" !== c && +l) && ue.exec(_.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; a--; )
    ...
    function be(e, t) {
        for (var n, i, o = [], r = 0, a = e.length; r < a; r++)
            ...
            t ? ("none" === n && (o[r] = oe.get(i, "display") || null,
            o[r] || (i.style.display = "")),
            "" === i.style.display && me(i) && (o[r] = ye(i))) : "none" !== n && (o[r] = "none",
            oe.set(i, "display", n)));
        for (r = 0; r < a; r++)
    ...
    var xe, we, _e = /^(?:checkbox|radio)$/i, Ce = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, Te = /^$|^module$|\/(?:java|ecma)script/i;
        ...
        _.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    i && (oe.set(this, t, _.event.trigger(i[0], i.slice(1), this)),
                    e.stopPropagation(),
                    e.isImmediatePropagationStopped = Ae)
            }
        })) : void 0 === oe.get(e, t) && _.event.add(e, t, Ae)
    }
    _.event = {
        global: {},
            ...
            if (v && (l = v.events)) {
                for (c = (t = (t || "").match(W) || [""]).length; c--; )
                    ...
                    f) {
                        ...
                        a = r = p.length; r--; )
                            u = p[r],
                            !o && m !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(r, 1),
                            u.selector && p.delegateCount--,
                            d.remove && d.remove.call(e, u));
                        a && !p.length && (d.teardown && !1 !== d.teardown.call(e, h, v.handle) || _.removeEvent(e, f, v.handle),
                        delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function(e) {
            var t, n, i, o, r, a, s = new Array(arguments.length), l = _.event.fix(e), c = (oe.get(this, "events") || Object.create(null))[l.type] || [], u = _.event.special[l.type] || {};
            for (s[0] = l,
            t = 1; t < arguments.length; t++)
                s[t] = arguments[t];
            if (l.delegateTarget = this,
            !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                for (a = _.event.handlers.call(this, l, c),
                t = 0; (o = a[t++]) && !l.isPropagationStopped(); )
                    ...
                    n = 0; (r = o.handlers[n++]) && !l.isImmediatePropagationStopped(); )
                        ...
                        l.data = r.data,
                        void 0 !== (i = ((_.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, s)) && !1 === (l.result = i) && (l.preventDefault(),
                        l.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        a = {},
                        n = 0; n < l; n++)
                            void 0 === a[o = (i = t[n]).selector + " "] && (a[o] = i.needsContext ? _(o, this).index(c) > -1 : _.find(o, this, null, [c]).length),
                            a[o] && r.push(i);
                        r.length && s.push({
                            elem: c,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return _e.test(t.type) && t.click && T(t, "input") && Le(t, "click", !0),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return _e.test(t.type) && t.click && T(t, "input") && Le(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    _.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ae : Pe,
    ...
    _.each({
        ...
        _.event.special[e] = {
            ...
            teardown: function() {
                ...
                if (!v.documentMode)
                    return !1;
                (e = oe.get(this, t) - 1) ? oe.set(this, t, e) : (this.removeEventListener(t, n),
                oe.remove(this, t))
            },
            _default: function(t) {
        ...
        _.event.special[t] = {
            setup: function() {
                var i = this.ownerDocument || this.document || this
                  ...
                  , r = oe.get(o, t);
                r || (v.documentMode ? this.addEventListener(t, n) : i.addEventListener(e, n, !0)),
                oe.set(o, t, (r || 0) + 1)
            },
            teardown: function() {
                var i = this.ownerDocument || this.document || this
                  , o = v.documentMode ? this : i
                  , r = oe.get(o, t) - 1;
                r ? oe.set(o, t, r) : (v.documentMode ? this.removeEventListener(t, n) : i.removeEventListener(e, n, !0),
                oe.remove(o, t))
            }
        }
    }
    ...
    _.each({
        ...
        _.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return o && (o === i || _.contains(i, o)) || (e.type = r.origType,
    ...
    function He(e, t) {
        ...
        if (1 === t.nodeType) {
            if (oe.hasData(e) && (s = oe.get(e).events))
                for (o in oe.remove(t, "handle events"),
                s)
                    for (n = 0,
                    i = s[o].length; n < i; n++)
                        _.event.add(t, o, s[o][n]);
            re.hasData(e) && (r = re.access(e),
            a = _.extend({}, r),
            re.set(t, a))
        }
    }
    ...
    function Be(e, t, n, i) {
        t = r(t);
        var o, a, s, l, c, u, d = 0, p = e.length, m = p - 1, v = t[0], g = h(v);
        if (g || p > 1 && "string" == typeof v && !f.checkClone && Fe.test(v))
        ...
        if (p && (a = (o = Ie(t, e[0].ownerDocument, !1, e, i)).firstChild,
        1 === o.childNodes.length && (o = a),
        a || i)) {
            for (l = (s = _.map(Se(o, "script"), Re)).length; d < p; d++)
                c = o,
                d !== m && (c = _.clone(c, !0, !0),
                l && _.merge(s, Se(c, "script"))),
                n.call(e[d], c, d);
            if (l)
                ...
                d = 0; d < l; d++)
                    c = s[d],
                    Te.test(c.type || "") && !oe.access(c, "globalEval") && _.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? _._evalUrl && !c.noModule && _._evalUrl(c.src, {
                        nonce: c.nonce || c.getAttribute("nonce")
                    }, u) : y(c.textContent.replace(ze, ""), c, u))
        }
        return e
    }
    function We(e, t, n) {
        for (var i, o = t ? _.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
            ...
            i.parentNode && (n && fe(i) && Ee(Se(i, "script")),
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    He(e, s);
            return (a = Se(s, "script")).length > 0 && Ee(a, !l && Se(e, "script")),
            s
        },
    ...
    _.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (_.cleanData(Se(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return Q(this, (function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !je.test(e) && !ke[(Ce.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = _.htmlPrefilter(e);
                    try {
                        for (; n < i; n++)
                            1 === (t = this[n] || {}).nodeType && (_.cleanData(Se(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return Be(this, arguments, (function(t) {
                ...
                _.inArray(this, e) < 0 && (_.cleanData(Se(this)),
    ...
    function Ve(e, t, n) {
        var i, o, r, a, s = Ze.test(t), l = e.style;
        return (n = n || Ye(e)) && (a = n.getPropertyValue(t) || n[t],
        s && a && (a = a.replace(I, "$1") || void 0),
        "" !== a || fe(e) || (a = _.style(e, t)),
        !f.pixelBoxStyles() && Ue.test(a) && Ke.test(t) && (i = l.width,
        o = l.minWidth,
        r = l.maxWidth,
    ...
    !function() {
        ...
        var i, o, r, a, s, l, c = v.createElement("div"), u = v.createElement("div");
    ...
    function at(e, t, n, i, o, r) {
        ...
        for (; a < 4; a += 2)
            ...
            i ? ("content" === n && (l -= _.css(e, "padding" + de[a], !0, o)),
            "margin" !== n && (l -= _.css(e, "border" + de[a] + "Width", !0, o))) : (l += _.css(e, "padding" + de[a], !0, o),
            "padding" !== n ? l += _.css(e, "border" + de[a] + "Width", !0, o) : s += _.css(e, "border" + de[a] + "Width", !0, o));
    ...
    function st(e, t, n) {
        ...
        return (!f.boxSizingReliable() && o || !f.reliableTrDimensions() && T(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === _.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === _.css(e, "boxSizing", !1, i),
        (r = s in e) && (a = e[s])),
        (a = parseFloat(a) || 0) + at(e, t, n || (o ? "border" : "content"), r, i, a) + "px"
    }
    ...
    _.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = te(t), l = Ze.test(t), c = e.style;
                if (l || (t = tt(s)),
                a = _.cssHooks[t] || _.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (o = a.get(e, !1, i)) ? o : c[t];
                "string" == (r = typeof n) && (o = ue.exec(n)) && o[1] && (n = ve(e, t, o),
                r = "number"),
    ...
    _.each(["height", "width"], (function(e, t) {
        _.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !nt.test(_.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? st(e, t, i) : Xe(e, it, (function() {
                        return st(e, t, i)
                    }
                    ))
            },
            set: function(e, n, i) {
                var o, r = Ye(e), a = !f.scrollboxSize() && "absolute" === r.position, s = (a || i) && "border-box" === _.css(e, "boxSizing", !1, r), l = i ? at(e, t, i, s, r) : 0;
                return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - at(e, t, "border", !1, r) - .5)),
                l && (o = ue.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n,
                n = _.css(e, t)),
                rt(0, n, l)
            }
        }
    ...
    _.cssHooks.marginLeft = Qe(f.reliableMarginLeft, (function(e, t) {
        if (t)
            return (parseFloat(Ve(e, "marginLeft")) || e.getBoundingClientRect().left - Xe(e, {
                marginLeft: 0
            }, (function() {
    ...
    function ft() {
        ut && (!1 === v.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(ft) : e.setTimeout(ft, _.fx.interval),
        _.fx.tick())
    }
    function ht() {
    ...
    function gt(e, t, n) {
        var i, o, r = 0, a = gt.prefilters.length, s = _.Deferred().always((function() {
            delete l.elem
        }
        )), l = function() {
            if (o)
                return !1;
            for (var t = ct || ht(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++)
                c.tweens[r].run(i);
    ...
    _.Animation = _.extend(gt, {
        tweeners: {
            "*": [function(e, t) {
                ...
                return ve(n.elem, e, ue.exec(t), n),
                n
            }
            ]
        },
        ...
        prefilters: [function(e, t, n) {
            var i, o, r, a, s, l, c, u, d = "width"in t || "height"in t, p = this, f = {}, h = e.style, m = e.nodeType && me(e), v = oe.get(e, "fxshow");
            ...
            if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(f))
                ...
                "none" === (u = _.css(e, "display")) && (c ? u = c : (be([e], !0),
                c = e.style.display || c,
                u = _.css(e, "display"),
                be([e]))),
                ("inline" === u || "inline-block" === u && null != c) && "none" === _.css(e, "float") && (l || (p.done((function() {
                    h.display = c
                }
                )),
                null == c && (u = h.display,
                ...
                l = !1,
                f)
                    l || (v ? "hidden"in v && (m = v.hidden) : v = oe.access(e, "fxshow", {
                        display: c
                    }),
                    r && (v.hidden = !m),
                    m && be([e], !0),
    ...
    _.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each((function() {
                var t, n = oe.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = _.timers, a = i ? i.length : 0;
                for (n.finish = !0,
                _.queue(this, e, []),
    ...
    _.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? _.prop(e, t, n) : (1 === r && _.isXMLDoc(e) || (o = _.attrHooks[t.toLowerCase()] || (_.expr.match.bool.test(t) ? yt : void 0)),
        ...
        toggleClass: function(e, t) {
            ...
            this.each((function() {
                if (s)
                    ...
                    void 0 !== e && "boolean" !== a || ((i = Ct(this)) && oe.set(this, "__className__", i),
                    this.setAttribute && this.setAttribute("class", i || !1 === e ? "" : oe.get(this, "__className__") || ""))
            }
            )))
        },
        hasClass: function(e) {
    ...
    _.extend(_.event, {
        trigger: function(t, n, i, o) {
            var r, a, s, l, c, d, p, f, g = [i || v], y = u.call(t, "type") ? t.type : t, b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = f = s = i = i || v,
            3 !== i.nodeType && 8 !== i.nodeType && !It.test(y + _.event.triggered) && (y.indexOf(".") > -1 && (b = y.split("."),
            y = b.shift(),
            b.sort()),
            c = y.indexOf(":") < 0 && "on" + y,
            ...
            o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                if (!o && !p.noBubble && !m(i)) {
                    ...
                    It.test(l + y) || (a = a.parentNode); a; a = a.parentNode)
                        g.push(a),
                        s = a;
                ...
                for (r = 0; (a = g[r++]) && !t.isPropagationStopped(); )
                    ...
                    (d = c && a[c]) && d.apply && ne(a) && (t.result = d.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = y,
                o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(g.pop(), n) || !ne(i) || c && h(i[y]) && !m(i) && ((s = i[c]) && (i[c] = null),
                _.event.triggered = y,
    ...
    _.fn.extend({
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var e = this.type;
                return this.name && !_(this).is(":disabled") && Lt.test(this.nodeName) && !Ot.test(e) && (this.checked || !_e.test(e))
            }
            )).map((function(e, t) {
                var n = _(this).val();
    ...
    function Zt(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var i, o = 0, r = t.toLowerCase().match(W) || [];
            if (h(n))
                for (; i = r[o++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    _.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var i, o, r, a, s, l, c, u, d, p, f = _.ajaxSetup({}, n), h = f.context || f, m = f.context && (h.nodeType || h.jquery) ? _(h) : _.event, g = _.Deferred(), y = _.Callbacks("once memory"), b = f.statusCode || {}, x = {}, w = {}, C = "canceled", T = {
                readyState: 0,
            ...
            if (g.promise(T),
            f.url = ((t || f.url || St.href) + "").replace(Ht, St.protocol + "//"),
            ...
            f.data && (f.processData || "string" == typeof f.data) && (o += (Dt.test(o) ? "&" : "?") + f.data,
            delete f.data),
            ...
            function k(t, n, a, l) {
                ...
                !d && _.inArray("script", f.dataTypes) > -1 && _.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function() {}
                ),
                x = function(e, t, n, i) {
                ...
                d ? (f.ifModified && ((w = T.getResponseHeader("Last-Modified")) && (_.lastModified[o] = w),
                ...
                send: function(o, r) {
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(Kt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                binary: s.response
                            } : {
                                text: s.responseText
    ...
    _.ajaxPrefilter("json jsonp", (function(t, n, i) {
        ...
        if (s || "jsonp" === t.dataTypes[0])
            ...
            s ? t[s] = t[s].replace(Jt, "$1" + o) : !1 !== t.jsonp && (t.url += (Dt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
    ...
    f.createHTMLDocument = ((Qt = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    _.parseHTML = function(e, t, n) {
        ...
        r = !n && [],
        (o = z.exec(e)) ? [t.createElement(o[1])] : (o = Ie([e], t, r),
    ...
    _.each(["top", "left"], (function(e, t) {
        _.cssHooks[t] = Qe(f.pixelPosition, (function(e, n) {
            if (n)
                return n = Ve(e, t),
                Ue.test(n) ? _(e).position()[t] + "px" : n
        }
        ))
    }
    )),
...
window.Modernizr = function(e, t, n) {
    ...
    var c, u, d = {}, p = t.documentElement, f = "modernizr", h = t.createElement(f), m = h.style, v = t.createElement("input"), g = ":)", y = {}.toString, b = " -webkit- -moz- -o- -ms- ".split(" "), x = "Webkit Moz O ms", w = x.split(" "), _ = x.toLowerCase().split(" "), C = "http://www.w3.org/2000/svg", T = {}, k = {}, S = {}, E = [], D = E.slice, I = function(e, n, i, o) {
        var r, a, s, l, c = t.createElement("div"), u = t.body, d = u || t.createElement("body");
        if (parseInt(i, 10))
            for (; i--; )
                (s = t.createElement("div")).id = o ? o[i] : f + (i + 1),
                c.appendChild(s);
        return r = ["&#173;", '<style id="s', f, '">', e, "</style>"].join(""),
        c.id = f,
        (u ? c : d).innerHTML += r,
        d.appendChild(c),
    ...
    for (var P in u = o(A, "undefined") || o(A.call, "undefined") ? function(e, t) {
    ...
    d.inputtypes = function(e) {
        for (var i, o, r, a = 0, s = e.length; s > a; a++)
            ...
            (i = "text" !== v.type) && (v.value = g,
            v.style.cssText = "position:absolute;visibility:hidden;",
            /^range$/.test(o) && v.style.WebkitAppearance !== n ? (p.appendChild(v),
            i = (r = t.defaultView).getComputedStyle && "textfield" !== r.getComputedStyle(v, null).WebkitAppearance && 0 !== v.offsetHeight,
            p.removeChild(v)) : /^(search|tel)$/.test(o) || (i = /^(url|email)$/.test(o) ? v.checkValidity && !1 === v.checkValidity() : v.value != g)),
            k[e[a]] = !!i;
        return k
    ...
    function(e, t) {
        ...
        function o(e, n, o) {
            return n || (n = t),
            l ? n.createElement(e) : (o || (o = i(n)),
            !(r = o.cache[e] ? o.cache[e].cloneNode() : d.test(e) ? (o.cache[e] = o.createElem(e)).cloneNode() : o.createElem(e)).canHaveChildren || u.test(e) || r.tagUrn ? r : o.frag.appendChild(r));
            var r
        }
        function r(e, t) {
            t.cache || (t.cache = {},
        ...
        var s, l, c = e.html5 || {}, u = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, d = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, p = "_html5shiv", f = 0, h = {};
        !function() {
            try {
        ...
        var m = {
            ...
            createDocumentFragment: function(e, o) {
                ...
                for (var r = (o = o || i(e)).frag.cloneNode(), a = 0, s = n(), c = s.length; c > a; a++)
                    r.createElement(s[a]);
                return r
            }
        };
    ...
    ,
    p.className = p.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + E.join(" "),
    d
}(this, this.document),
function(e, t) {
    ...
    function i(e) {
        if (e in t.style)
            return e;
        for (var n = ["Moz", "Webkit", "O", "ms"], i = e.charAt(0).toUpperCase() + e.substr(1), o = 0; o < n.length; ++o) {
            var r = n[o] + i;
            if (r in t.style)
                return r
        }
    ...
    n.filter = i("Filter"),
    n.transform3d = (t.style[n.transform] = "",
    ...
    e.cssHooks["transit:transform"] = {
        ...
        set: function(t, i) {
            var r = i;
            r instanceof s || (r = new s(r)),
            "WebkitTransform" !== n.transform || o ? t.style[n.transform] = r.toString() : t.style[n.transform] = r.toString(!0),
        ...
        toString: function(e) {
            ...
            for (var i in this)
                if (this.hasOwnProperty(i)) {
                    if (!n.transform3d && ("rotateX" === i || "rotateY" === i || "perspective" === i || "transformOrigin" === i))
                        continue;
    ...
    e.fn.transition = e.fn.transit = function(t, i, o, a) {
        var s = this
          , u = 0
          , d = !0
          , p = e.extend(!0, {}, t);
        ...
        o = void 0),
        void 0 !== p.easing && (o = p.easing,
        delete p.easing),
        void 0 !== p.duration && (i = p.duration,
        delete p.duration),
        void 0 !== p.complete && (a = p.complete,
        delete p.complete),
        void 0 !== p.queue && (d = p.queue,
        delete p.queue),
        ...
        i = f(i);
        var h = c(p, i, o, u)
          , m = e.transit.enabled && n.transition ? parseInt(i, 10) + parseInt(u, 10) : 0;
        if (0 === m)
            return l(s, d, (function(e) {
                s.css(p),
                a && a.apply(s),
                e && e()
            }
        ...
        return l(s, d, (function(t) {
            ...
            ,
            m > 0 && r && e.transit.useTransitionEnd ? (o = !0,
            s.bind(r, l)) : window.setTimeout(l, m),
            s.each((function() {
                m > 0 && (this.style[n.transition] = h),
                e(this).css(p)
            }
            ))
        }
...
function(e) {
    ...
    function l(i) {
        ...
        "axis"in o && o.axis === o.HORIZONTAL_AXIS && (d = -1 * p,
        p = 0),
        l = 0 === p ? d : p,
        ...
        0 !== p || 0 !== d) {
            ...
            if (f = Math.max(Math.abs(p), Math.abs(d)),
            (!n || f < n) && (n = f,
            u(o, f) && (n /= 40)),
            u(o, f) && (l /= 40,
            d /= 40,
          ...
          , i = function() {
            ...
            return n(e, [{
                ...
                value: function(e, t, n) {
                    ...
                    if ("<" === i || "&" === i) {
                        var o;
                        for (o = "<" === i ? ">" : ";"; e.substr(t + 1).charAt(0) !== o && !(1 + ++t > e.length); )
                            ;
                        t++
                    }
                    return t
    ...
    JQClass.classes.JQPlugin = JQClass.extend({
        ...
        option: function(e, t, n) {
            var i = (e = $(e)).data(this.name)
              , o = t || {};
            return !t || "string" == typeof t && void 0 === n ? (o = (i || {}).options) && t ? o[t] : o : void (e.hasClass(this._getMarker()) && ("string" == typeof t && (o = {},
            o[t] = n),
        ...
        destroy: function(e) {
            (e = $(e)).hasClass(this._getMarker()) && (this._preDestroy(e, this._getInst(e)),
    ...
    e.JQPlugin.createPlugin({
        ...
        _init: function() {
            ...
            var n = "function" == typeof Date.now ? Date.now : function() {
              ...
              , r = 0;
            !o || e.noRequestAnimationFrame ? (e.noRequestAnimationFrame = null,
            e.countdown._timer = setInterval((function() {
                t._updateElems()
            }
            ), 1e3)) : (r = window.animationStartTime || window.webkitAnimationStartTime || window.mozAnimationStartTime || window.oAnimationStartTime || window.msAnimationStartTime || n(),
            o((function e(a) {
                var s = a < 1e12 ? i ? window.performance.now() + performance.getEntriesByType("navigation")[0].startTime : n() : a || n();
                s - r >= 1e3 && (t._updateElems(),
                r = s),
                o(e)
            }
            )))
        ...
        UTCDate: function(e, t, n, i, o, r, a, s) {
            "object" == typeof t && t instanceof Date && (s = t.getMilliseconds(),
            a = t.getSeconds(),
            r = t.getMinutes(),
            o = t.getHours(),
            i = t.getDate(),
        ...
        resync: function() {
            ...
            e("." + this._getMarker()).each((function() {
                ...
                if (n.options.serverSync) {
                    ...
                    if (t._eqNull(i[2])) {
                        var r = typeof n.options.serverSync === "function" ? n.options.serverSync.apply(this, []) : null;
            ...
            for (var n = 0; n < t._serverSyncs.length; n++)
                t._eqNull(t._serverSyncs[n][2]) || (t._serverSyncs[n][1] += t._serverSyncs[n][2],
        ...
        _optionsChanged: function(t, n, i) {
            ...
            this._adjustSettings(t, n, !this._eqNull(i.until) || !this._eqNull(i.since) || o);
            var r = new Date;
            (n._since && n._since < r || n._until && n._until > r) && this._addElem(t[0]),
            this._updateCountdown(t, n)
        },
        _updateCountdown: function(t, n) {
            if (t = t.jquery ? t : e(t),
            n = n || this._getInst(t)) {
                if (t.html(this._generateHTML(n)).toggleClass(this._rtlClass, n.options.isRTL),
                    "pause" !== n._hold && typeof n.options.onTick === "function") {
                ...
                if ("pause" !== n._hold && (n._since ? n._now.getTime() < n._since.getTime() : n._now.getTime() >= n._until.getTime()) && !n._expiring) {
                    ...
                    this._hasElem(t[0]) || n.options.alwaysExpire) {
                        if (this._removeElem(t[0]),
                            typeof n.options.onExpiry === "function" && n.options.onExpiry.apply(t[0], []),
                    ...
                    "pause" === n._hold && this._removeElem(t[0])
            }
        },
        _resetExtraLabels: function(e, t) {
            ...
            for (n in e)
                n.match(/[Ll]abels[02-9]|compactLabels1/) && void 0 === t[n] && (e[n] = null)
        },
        _eqNull: function(e) {
            return null == e
        },
        _adjustSettings: function(t, n, i) {
            ...
            var a = null
              , s = null;
            if (this._eqNull(o)) {
                var l = typeof n.options.serverSync === "function" ? n.options.serverSync.apply(t[0], []) : null;
                a = new Date,
            ...
            (i || !i && this._eqNull(n._until) && this._eqNull(n._since)) && (n._since = n.options.since,
            this._eqNull(n._since) || (n._since = this.UTCDate(c, this._determineTime(n._since, null)),
        ...
        _generateHTML: function(t) {
            ...
            var l = [!1, !1, !1, !1, !1, !1, !1];
            for (s = 6; s >= 0; s--)
                t._show[s] && (t._periods[s] ? l[s] = !0 : (l[s] = r > 0,
                r--));
        ...
        _minDigits: function(e, t, n) {
            return (t = "" + t).length >= n ? this._translateDigits(e, t) : (t = "0000000000" + t,
        ...
        _determineShow: function(e) {
            var t = e.options.format
              , n = [];
            return n[0] = t.match("y") ? "?" : t.match("Y") ? "!" : null,
        ...
        _calculatePeriods: function(e, t, n, i) {
            ...
            e._since ? i.getTime() < e._since.getTime() ? e._now = i = o : i = e._since : (o.setTime(e._until.getTime()),
...
function(e) {
    e.fn.skillBars = function(t) {
        ...
        return this.each((function() {
            ...
            i > 100 && (i = 100);
            var o = n.from
              , r = Math.ceil(n.speed / n.interval)
              , a = (i - o) / r
              , s = 0
              , l = setInterval((function() {
                o += a,
                s++,
                e(t).find(n.classes.skillBarPercent).text(o.toFixed(n.decimals) + "%"),
                "function" == typeof n.onUpdate && n.onUpdate.call(t, o),
                s >= r && (clearInterval(l),
                o = i,
                "function" == typeof n.onComplete && n.onComplete.call(t, o))
            }
            ), n.interval);
...
function(e) {
    ...
    var t, n, i, o, r, a, s = "Close", l = "MarkupParse", c = "Open", u = "Change", d = ".mfp", p = "mfp-ready", f = "mfp-prevent-close", h = function() {}, m = !!window.jQuery, v = e(window), g = function(e, n) {
        t.ev.on("mfp" + e + d, n)
    }, y = function(t, n, i, o) {
    ...
    h.prototype = {
        ...
        open: function(n) {
            ...
            if (!t.isOpen) {
                ...
                t.bgOverlay || (t.bgOverlay = y("bg").on("click.mfp", (function() {
                    t.close()
                }
                )),
                t.wrap = y("wrap").attr("tabindex", -1).on("click.mfp", (function(e) {
                    t._checkIfClose(e.target) && t.close()
                }
                )),
                t.container = y("container", t.wrap)),
                t.contentContainer = y("content"),
                t.st.preloader && (t.preloader = y("preloader", t.container, t.st.tLoading));
                ...
                b("BeforeOpen"),
                t.st.showCloseBtn && (t.st.closeBtnInside ? (g(l, (function(e, t, n, i) {
    ...
    e.fn.magnificPopup = function(n) {
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var o, r = m ? i.data("magnificPopup") : i[0].magnificPopup, a = parseInt(arguments[1], 10) || 0;
    ...
    ;
    var _, C, T, k = "inline", S = function() {
        T && (C.after(T.addClass(_)).detach(),
        T = null)
    };
            ...
            getInline: function(n, i) {
                ...
                n.src) {
                    ...
                    if (r.length) {
                        ...
                        a && a.tagName && (C || (_ = o.hiddenClass,
                        C = y(_),
                        _ = "mfp-" + _),
                        T = r.after(C).detach().removeClass(_)),
                ...
                var n = 0
                  ...
                  , o = function(r) {
                    ...
                    A = setInterval((function() {
                        i.naturalWidth > 0 ? t._onImageHasSize(e) : (n > 200 && clearInterval(A),
            ...
            getImage: function(n, i) {
                var o = 0
                  , r = function() {
                    ...
                    n.hasSize = !0,
                    n.loaded = !0,
                    b("ImageLoadComplete")) : ++o < 200 ? setTimeout(r, 100) : a())
                }
                  , a = function() {
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && t.supportsTransition) {
                    var i, o, r = n.duration, a = function(e) {
            ...
            _getOffset: function(n) {
                ...
                var s = {
                    width: i.width(),
                    height: (m ? i.innerHeight() : i[0].offsetHeight) - a - r
                };
                return void 0 === P && (P = void 0 !== document.createElement("p").style.MozTransform),
                P ? s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)" : (s.left = o.left,
                s.top = o.top),
                s
            }
        }
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina
                      , n = e.ratio;
                    (n = isNaN(n) ? n() : n) > 1 && (g("ImageHasSize.retina", (function(e, t) {
                        t.img.css({
...
function(e) {
    ...
    i.prototype = {
        _init: function() {
            var t, n, i, o, r = "BODY" === this.elmt.tagName, a = this.settings.timer, s = this.settings.overlay, l = this;
            this._preload(),
            r || (n = e('<div class="vegas-content-scrollable">'),
            ...
            this.elmt.innerHTML = ""),
            a && this.support.transition && (o = e('<div class="vegas-timer"><div class="vegas-timer-progress">'),
            this.$timer = o,
            this.$elmt.prepend(o)),
            s && (i = e('<div class="vegas-overlay">'),
            "string" == typeof s && i.css("background-image", "url(" + s + ")"),
            this.$overlay = i,
            this.$elmt.prepend(i)),
            this.$elmt.addClass("vegas-container"),
            r || (this.$elmt.append(n),
            n.append(t)),
            setTimeout((function() {
                l.trigger("init"),
                l._goto(l.slide),
        ...
        _preload: function() {
            ...
            for (e = 0; e < this.settings.slides.length; e++)
                ...
                (this.settings.preload || this.settings.preloadVideos) && this.support.video && this.settings.slides[e].video && (this.settings.slides[e].video instanceof Array ? this._video(this.settings.slides[e].video) : this._video(this.settings.slides[e].video.src))
        },
        _random: function(e) {
        ...
        _timer: function(e) {
            ...
            this.ended || this.paused || this.noshow || e && setTimeout((function() {
        ...
        _video: function(e) {
            ...
            return n[o] ? n[o] : (e instanceof Array || (e = [e]),
        ...
        _options: function(e, t) {
            ...
            void 0 !== this.settings.slides[t][e] ? this.settings.slides[t][e] : this.settings[e]
        },
        _goto: function(t) {
            void 0 === this.settings.slides[t] && (t = 0),
            this.slide = t;
            var n, i, o, r, a, s = this.$elmt.children(".vegas-slide"), l = this.settings.slides[t].src, c = this.settings.slides[t].video, u = this._options("delay"), d = this._options("align"), p = this._options("valign"), f = this._options("cover"), h = this._options("color") || this.$elmt.css("background-color"), m = this, v = s.length, g = this._options("transition"), y = this._options("transitionDuration"), b = this._options("animation"), x = this._options("animationDuration");
            function w() {
                m._timer(!0),
                setTimeout((function() {
                    g && (m.support.transition ? (s.css("transition", "all " + y + "ms").addClass("vegas-transition-" + g + "-out"),
                    s.each((function() {
            ...
            this.support.video && c ? ((r = c instanceof Array ? this._video(c) : this._video(c.src)).loop = void 0 === c.loop || c.loop,
            r.muted = void 0 === c.mute || c.mute,
            !1 === r.muted ? (r.volume = 0,
            this._fadeInSound(r, y)) : r.pause(),
            o = e(r).addClass("vegas-video").css("background-color", h),
            this.support.objectFit ? o.css("object-position", d + " " + p).css("object-fit", f).css("width", "100%").css("height", "100%") : "contain" === f && o.css("width", "100%").css("height", "100%"),
            n.append(o)) : (a = new Image,
            i = e('<div class="vegas-slide-inner"></div>').css("background-image", 'url("' + l + '")').css("background-color", h).css("background-position", d + " " + p),
            "repeat" === f ? i.css("background-repeat", "repeat") : i.css("background-size", f),
            this.support.transition && b && i.addClass("vegas-animation-" + b).css("animation-duration", x + "ms"),
            n.append(i)),
            ...
            s.css("transition", "all 0ms").each((function() {
                ...
                g && (this.className += " vegas-transition-" + g,
        ...
        jump: function(e) {
            e < 0 || e > this.total - 1 || e === this.slide || (this.slide = e,
        ...
        trigger: function(e) {
            var t;
            t = "init" === e ? [this.settings] : [this.slide, this.settings.slides[this.slide]],
            this.$elmt.trigger("vegas" + e, t),
            "function" == typeof this.settings[e] && this.settings[e].apply(this.$elmt, t)
        },
        options: function(n, i) {
            ...
            this.settings.slides !== o && (this.total = this.settings.slides.length,
            this.noshow = this.total < 2,
            this._preload())
        },
        destroy: function() {
...
var pJS = function(e, t) {
    ...
    i.fn.particle = function(e, t, n) {
        ...
        i.particles.move.straight ? (this.vx = r.x,
        this.vy = r.y,
    ...
    i.fn.particle.prototype.draw = function() {
        ...
        if (null != e.opacity_bubble)
            ...
            n = e.opacity;
        if (e.color.rgb)
            var o = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + n + ")";
        else
            o = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + n + ")";
        switch (i.canvas.ctx.fillStyle = o,
    ...
    i.fn.particlesUpdate = function() {
        for (var e = 0; e < i.particles.array.length; e++) {
            ...
            if (t.x - t.radius > i.canvas.w ? (t.x = o.x_left,
            t.y = Math.random() * i.canvas.h) : t.x + t.radius < 0 && (t.x = o.x_right,
            t.y = Math.random() * i.canvas.h),
            t.y - t.radius > i.canvas.h ? (t.y = o.y_top,
            t.x = Math.random() * i.canvas.w) : t.y + t.radius < 0 && (t.y = o.y_bottom,
            ...
            if (c <= i.interactivity.modes.bubble.distance) {
                if (o >= 0 && "mousemove" == i.interactivity.status) {
                    if (i.interactivity.modes.bubble.size != i.particles.size.value)
                        if (i.interactivity.modes.bubble.size > i.particles.size.value)
                            (s = e.radius + i.interactivity.modes.bubble.size * o) >= 0 && (e.radius_bubble = s);
                        else {
            ...
            function d(t, n, o, r, a) {
                if (t != n)
                    if (i.tmp.bubble_duration_end)
                        null != o && (l = t + (t - (r - u * (r - t) / i.interactivity.modes.bubble.duration)),
    ...
    i.fn.modes.repulseParticle = function(e) {
        if (i.interactivity.events.onhover.enable && isInArray("repulse", i.interactivity.events.onhover.mode) && "mousemove" == i.interactivity.status) {
            ...
            "bounce" == i.particles.move.out_mode ? (s.x - e.radius > 0 && s.x + e.radius < i.canvas.w && (e.x = s.x),
            s.y - e.radius > 0 && s.y + e.radius < i.canvas.h && (e.y = s.y)) : (e.x = s.x,
            e.y = s.y)
    ...
    i.fn.vendors.checkOverlap = function(e, t) {
        for (var n = 0; n < i.particles.array.length; n++) {
            var o = i.particles.array[n]
              , r = e.x - o.x
              , a = e.y - o.y;
            Math.sqrt(r * r + a * a) <= e.radius + o.radius && (e.x = t ? t.x : Math.random() * i.canvas.w,
    ...
    i.fn.vendors.createSvgImg = function(e) {
        var t = i.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, (function(t, n, i, o) {
            if (e.color.rgb)
                ...
                r = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + e.opacity + ")";
            return r
        }
        ))
          , n = new Blob([t],{
    ...
    ,
        i.fn.vendors.start = function () {
            isInArray("image", i.particles.shape.type) ? (i.tmp.img_type = i.particles.shape.image.src.slice(i.particles.shape.image.src.length - 3),
...
function(e, t) {
    ...
    return function(e, t, n, i) {
        ...
        o.extend(a, i);
        var s, l, c, u, d, p, f, h, m, v, g, y, b, x, w, _, C, T, k, S, E, D, I, M, A, P, O, L, j, F, z, N, R, q, H, $, B, W, U, Z, Y, X, K, V, Q, G, J, ee, te, ne, ie, oe, re, ae, se, le, ce = {
            x: 0,
            y: 0
        }, ue = {
            x: 0,
            ...
            x: 0,
            y: 0
        }, ve = 0, ge = !0, ye = [], be = {}, xe = !1, we = function(e, t) {
            ...
            (!xe || o && o !== r.currItem) && (i /= o ? o.fitRatio : r.currItem.fitRatio),
            e[D] = y + t + "px, " + n + "px" + b + " scale(" + i + ")"
        }, Ie = function(e) {
            te && (e && (v > r.currItem.fitRatio ? xe || (Vt(r.currItem, !1, !0),
            xe = !0) : xe && (Vt(r.currItem),
            xe = !1)),
            De(te, de.x, de.y, v))
        }, Me = function(e) {
            ...
            if (!a.loop && t) {
                var n = u + (me.x * fe - e) / me.x
                  , i = Math.round(e - ut.x);
                (n < 0 && i > 0 || n >= Ht() - 1 && i < 0) && (e = ut.x + i * a.mainScrollEndFriction)
            }
            ut.x = e,
            Ae(e, d)
        }, Oe = function(e, t) {
            ...
            Fe && (o.unbind(document, "mousemove", ze),
            ...
            e && (X || Y || ne || B) && (e.preventDefault(),
            e.stopPropagation())
        }, We = function() {
            r.setScrollOffset(0, o.getScrollY())
        }, Ue = {}, Ze = 0, Ye = function(e) {
            Ue[e] && (Ue[e].raf && P(Ue[e].raf),
            Ze--,
            delete Ue[e])
        }, Xe = function(e) {
            Ue[e] && Ye(e),
            ...
            for (var e in Ue)
                Ue.hasOwnProperty(e) && Ye(e)
        }, Ve = function(e, t, n, i, o, r, a) {
            var s, l = Se();
            Xe(e);
            var c = function() {
                if (Ue[e]) {
            ...
            init: function() {
                if (!s && !l) {
                    ...
                    for (z.animationName && z.transform && !i || (a.showAnimationDuration = a.hideAnimationDuration = 0),
                    n = 0; n < ye.length; n++)
                        r["init" + ye[n]]();
                    ...
                    ve = null,
                    n = 0; n < 3; n++)
                        Ae((n + p) * me.x, _[n].el.style);
                    j || o.bind(r.scrollWrap, h, r),
                    Te("initialZoomInEnd", (function() {
                        ...
                        z.transform && o.bind(r.scrollWrap, "click", r),
                        a.mouseUsed || o.bind(document, "mousemove", ze),
            ...
            close: function() {
                ...
                z.transform && o.unbind(r.scrollWrap, "click", r),
                U && o.unbind(window, f, r),
                clearTimeout(N),
                ke("unbindEvents"),
                $t(r.currItem, null, !0, r.destroy))
            },
            destroy: function() {
                ke("destroy"),
                Ft && clearTimeout(Ft),
                ...
                if (0 !== ve) {
                    ...
                    if (!(e && n < 2)) {
                        ...
                        for (var i = 0; i < n; i++)
                            ...
                            _[2] = t,
                            p++,
                            Ae((p + 2) * me.x, t.el.style),
                            r.setContent(t, u - n + i + 1 + 1)) : (t = _.pop(),
                            _.unshift(t),
                            p--,
                            Ae(p * me.x, t.el.style),
                            r.setContent(t, u + n - i - 1 - 1));
                        if (te && 1 === Math.abs(ve)) {
                            var o = qt(C);
                            o.initialZoomLevel !== v && (Zt(o, pe),
                            Vt(o),
                            Me(o))
                        }
                        ve = 0,
            ...
            updateSize: function(t) {
                ...
                if (pe.x = r.scrollWrap.clientWidth,
                ...
                void 0 !== p) {
                    for (var i, s, l, c = 0; c < 3; c++)
                        i = _[c],
                        Ae((c + p) * me.x, i.el.style),
                        l = u + c - 1,
                        a.loop && Ht() > 2 && (l = _e(l)),
                        (s = qt(l)) && (w || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s),
                        r.setContent(i, l),
                        1 === c && (r.currItem = s,
            ...
            ))) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Tt[0] = bt(e.touches[0], _t),
            e.touches.length > 1 && (Tt[1] = bt(e.touches[1], Ct))) : (_t.x = e.pageX,
            _t.y = e.pageY,
            _t.id = "",
            Tt[0] = _t),
            Tt
            ...
            l = de[e] + t[e] * n,
            (a.allowPanToNext || v === r.currItem.initialZoomLevel) && (te ? "h" !== ie || "x" !== e || Y || (c ? (l > ee.min[e] && (n = a.panEndFriction,
            ee.min[e],
            i = ee.min[e] - ue[e]),
            (i <= 0 || d < 0) && Ht() > 1 ? (s = u,
            d < 0 && u > ot.x && (s = ot.x)) : ee.min.x !== ee.max.x && (o = l)) : (l < ee.max[e] && (n = a.panEndFriction,
            ee.max[e],
            i = ue[e] - ee.max[e]),
            (i <= 0 || d > 0) && Ht() > 1 ? (s = u,
            d > 0 && u < ot.x && (s = ot.x)) : ee.min.x !== ee.max.x && (o = l))) : s = u,
            "x" === e))
                return void 0 !== s && (Pe(s, !0),
                V = s !== ot.x),
                ee.min.x !== ee.max.x && (void 0 !== o ? de.x = o : V || (de.x += t.x * n)),
                void 0 !== s;
            ne || V || v > r.currItem.fitRatio && (de[e] += t[e] * n)
        }, Et = function(e) {
            ...
            X || Y || ne || B)
                ...
                B)
                    ...
                    ne || ("swipe" === i ? !V && v > r.currItem.fitRatio && Pt(H) : jt())
                }
        }, At = function() {
            var e, t, n = {
                lastFlickOffset: {},
                ...
                calculateSwipeSpeed: function(i) {
                    rt.length > 1 ? (e = Se() - q + 50,
                    t = rt[rt.length - 2][i]) : (e = Se() - R,
                    t = nt[i]),
                ...
                panAnimLoop: function() {
                    if (Ue.zoomPan && (Ue.zoomPan.raf = A(n.panAnimLoop),
                    n.now = Se(),
            ...
            i && ((u += i) < 0 ? (u = a.loop ? Ht() - 1 : 0,
            s = !0) : u >= Ht() && (u = a.loop ? 0 : Ht() - 1,
            s = !0),
            s && !a.loop || (ve += i,
            fe -= i,
            n = !0));
            var d, p = me.x * fe, f = Math.abs(p - ut.x);
            return n || p > ut.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? f / Math.abs(t.lastFlickSpeed.x) : 333,
            d = Math.min(d, 400),
            d = Math.max(d, 250)) : d = 333,
            st === u && (n = !1),
            ne = !0,
            ke("mainScrollAnimStart"),
            Ve("mainScroll", ut.x, p, d, o.easing.cubic.out, Pe, (function() {
                Ke(),
                ne = !1,
                st = -1,
        ...
        we("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    (I = z.pointerEvent) && z.touch && (z.touch = !1),
                    I ? navigator.msPointerEnabled ? e("MSPointer", "Down", "Move", "Up", "Cancel") : e("pointer", "down", "move", "up", "cancel") : z.touch ? (e("touch", "start", "move", "end", "cancel"),
        ...
        var Ft, zt, Nt, Rt, qt, Ht, $t = function(t, n, i, s) {
            var l;
            Ft && clearTimeout(Ft),
            Rt = !0,
            Nt = !0,
            t.initialLayout ? (l = t.initialLayout,
            t.initialLayout = null) : l = a.getThumbBoundsFn && a.getThumbBoundsFn(u);
            var d, p, f = i ? a.hideAnimationDuration : a.showAnimationDuration, h = function() {
                Ye("initialZoom"),
                i ? (r.template.removeAttribute("style"),
                r.bg.removeAttribute("style")) : (Ee(1),
            ...
            p && (i ? o[(d ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout((function() {
                ...
                i) {
                    var n = l.w / t.w
                      ...
                      , c = function(t) {
                        1 === t ? (v = n,
                        de.x = l.x,
                        de.y = l.y - F) : (v = (n - a) * t + a,
                        de.x = (l.x - r.x) * t + r.x,
                        de.y = (l.y - F - r.y) * t + r.y),
                        Ie(),
                        p ? e.style.opacity = 1 - t : Ee(s - t * s)
                    };
                    d ? Ve("initialZoom", 0, 1, f, o.easing.cubic.out, c, h) : (c(1),
                    Ft = setTimeout(h, f + 20))
                } else
                    v = t.initialZoomLevel,
                    Le(de, t.initialPosition),
                    Ie(),
            ...
            if (Wt.length) {
                for (var e, t = 0; t < Wt.length; t++)
                    (e = Wt[t]).holder.index === e.index && Yt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                Wt = []
            }
        };
        we("Controller", {
            publicMethods: {
                lazyLoadItem: function(e) {
                    e = _e(e);
                    var t = qt(e);
                    t && (!t.loaded && !t.loading || w) && (ke("gettingData", e, t),
                    t.src && Xt(t))
                },
                ...
                setContent: function(e, t) {
                    ...
                    if (l) {
                        ...
                        !l.src || l.loadError || l.loaded)
                            ...
                            if (l.loadComplete = function(n) {
                                if (s) {
                                    if (e && e.index === t) {
                                        ...
                                        n.imageAppended ? !Rt && n.placeholder && (n.placeholder.style.display = "none",
                                        n.placeholder = null) : z.transform && (ne || Rt) ? Wt.push({
                                            item: n,
                                            baseDiv: c,
                                            img: n.img,
                                            index: t,
                            ...
                            l.loading || Xt(l),
                            r.allowProgressiveImg() && (!Nt && z.transform ? Wt.push({
                                item: l,
                                baseDiv: c,
                                img: l.img,
                                index: t,
        ...
        var Gt, Jt, en = {}, tn = function(e, t, n) {
            ...
            var customEvent = new CustomEvent("pswpTap", {
                detail: o,
                bubbles: true,
                cancelable: true
            });
            ...
            publicMethods: {
                ...
                handleMouseWheel: function(e) {
                    if (v <= r.currItem.fitRatio)
                        return a.modal && (!a.closeOnScroll || Ze || U ? e.preventDefault() : D && Math.abs(e.deltaY) > 2 && (c = !0,
                        r.close())),
                        !0;
        ...
        var nn, on, rn, an, sn, ln, cn, un, dn, pn, fn, hn, mn = {
            ...
            Ze || U)
                ...
                hn ? "#" + n !== window.location.hash && history[un ? "replaceState" : "pushState"]("", document.title, i) : un ? fn.replace(i) : fn.hash = n,
                un = !0,
            ...
            publicMethods: {
                initHistory: function() {
                    ...
                    a.history) {
                        ...
                        var e = function() {
                            ln = !0,
                            dn || (pn ? history.back() : cn ? fn.hash = cn : hn ? history.pushState("", document.title, fn.pathname + fn.search) : fn.hash = ""),
                            gn()
                        };
                        Te("unbindEvents", (function() {
                            c && e()
...
function(e, t) {
    ...
    "use strict";
    return function(e, t) {
        var n, i, o, r, a, s, l, c, u, d, p, f, h, m, v, g, y, b, x = this, w = !1, _ = !0, C = !0, T = {
            barsSize: {
                top: 44,
                bottom: "auto"
            },
            ...
            if (g)
                return !0;
            v.timeToIdle && v.mouseUsed && !u && L();
            for (var n, i, o = (e.target || e.srcElement).getAttribute("class") || "", r = 0; r < N.length; r++)
                (n = N[r]).onTap && o.indexOf("pswp__" + n.name) > -1 && (n.onTap(),
                i = !0);
            if (i) {
        ...
        x.init = function() {
            ...
            d("onPinchClose", (function(e) {
                _ && e < .9 ? (x.hideControls(),
                a = !0) : a && !_ && e > .9 && x.showControls()
            }
            )),
        ...
        ,
        x.update = function() {
            _ && e.currItem ? (x.updateIndexIndicator(),
        ...
        x.onGlobalTap = function(n) {
            ...
            if (!g)
                ...
                } else if (v.tapToToggleControls && (_ ? x.hideControls() : x.showControls()),
    ...
    e.fn.ajaxChimp = function(t) {
        return e(this).each((function(n, i) {
            ...
            o.submit((function() {
                ...
                e.ajax({
                    ...
                    success: function(n) {
                        if ("success" === n.result)
                            ...
                            try {
                                var i = n.msg.split(" - ", 2);
                                void 0 === i[1] ? t = n.msg : parseInt(i[0], 10).toString() === i[0] ? (i[0],
                                t = i[1]) : t = n.msg
                            } catch (e) {
                                t = n.msg
                            }
                        }
                        "en" !== s.language && void 0 !== e.ajaxChimp.responses[t] && e.ajaxChimp.translations && e.ajaxChimp.translations[s.language] && e.ajaxChimp.translations[s.language][e.ajaxChimp.responses[t]] && (t = e.ajaxChimp.translations[s.language][e.ajaxChimp.responses[t]]),
                        a.html(t),
                        a.show(2e3),
                ...
                var c = "Submitting...";
                return "en" !== s.language && e.ajaxChimp.translations && e.ajaxChimp.translations[s.language] && e.ajaxChimp.translations[s.language].submit && (c = e.ajaxChimp.translations[s.language].submit),
                a.html(c).show(2e3),
                !1
            }
            ))
...
$((function() {
    ...
    s.on("click", (function(e) {
        ...
        setTimeout((function() {
            ...
            r.removeClass("animate-in animate-out"),
